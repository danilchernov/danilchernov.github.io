(function (factory) {
    ...
    var sidebar = (function () {
      var $body = $('body');
      var $openBtn = $('.menu-button_burger');
    ...
    function () {
      function Tooltip(options) {
        ...
        this.options = options;
        this.element = document.getElementById(options.id).content.querySelector('.js-tooltip');
        this.placeSelector = options.placeToDisplay;
        this.placeToDisplay = null;
      }

      createClass(Tooltip, [{
        key: "registerDisplayPlace",
        value: function registerDisplayPlace() {
        ...
        value: function updateElementContent(str) {
          var content = this.element.querySelector('.js-tooltip-number');
          content.textContent = str;
        }
      }, {
        key: "updateElement",
        value: function updateElement(newPosition, newContent) {
    ...
    var customRange = (function () {
      var containers = document.querySelectorAll('.js-custom-range-slider');

      if (containers.length) {
        containers.forEach(function (container) {
          var slider = container.querySelector('.js-custom-range-slider-target'); // eslint-disable-next-line prettier/prettier

          var sliderTotal = container.querySelector('.js-custom-range-slider-total');
          ...
          var pips = {
            ...
            clickOnPip: function clickOnPip() {
          ...
          function convertToFormat(number) {
            var localFormat = wNumb({
              thousand: ' ',
              postfix: '',
              decimals: 0
            });
            var localValue = localFormat.to(number);
            return localValue;
          }
          ...
          function checkLimit(limit) {
            var bar = document.querySelector('.custom-range-slider .noUi-connect');
    ...
    var map = (function () {
      ...
      function init() {
        ...
        var placemark = new ymaps.Placemark([53.3348, 83.7769], {
